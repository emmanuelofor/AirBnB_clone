#!/usr/bin/python3
"""These are the Tests for the AirBnb clone modules.
"""
import os
...
def clear_stream(stream: TextIO):
    """this function Clears the contents of a given stream
...
def reset_store(store: FileStorage, file_path='file.json'):
    """This function Resets the items in the given store.
    Args:
...
def read_text_file(file_name):
    """This function Reads the contents of a given file.
...
def write_text_file(file_name, text):
    """This function Writes a text to a given file.
